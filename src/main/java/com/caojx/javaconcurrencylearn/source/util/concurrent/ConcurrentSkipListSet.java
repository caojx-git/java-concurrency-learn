...
/**
 * 源码分析参考文章：https://segmentfault.com/a/1190000016214450
 * <p>
 ...
 * <p>
 * ConcurrentSkipListSet实现了NavigableSet接口，与ConcurrentSkipListMap实现的NavigableMap接口类似，以提供和排序相关的功能，维持元素的有序性，所以ConcurrentSkipListSet就是一种为并发环境设计的有序SET工具类。
 * <p>
...
public class ConcurrentSkipListSet<E>
    ...
    /**
     * ConcurrentSkipListMap对键值对的要求是均不能为null，所以ConcurrentSkipListSet在插入元素的时候，用一个Boolean.TRUE对象作为value，
     * 同时putIfAbsent可以保证不会存在相同的Key。所以，最终跳表中的所有Node结点的Key均不会相同，且值都是Boolean.True
     * <p>
