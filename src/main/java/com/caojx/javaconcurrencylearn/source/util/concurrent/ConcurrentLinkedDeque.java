 ...
 * https://blog.csdn.net/weixin_42146366/java/article/details/88012792
 * <p>
 ...
 * <p>
 * ConcurrentLinkedDeque相比ConcurrentLinkedQueue，功能更丰富，但是由于底层结构是双链表，且完全采用CAS+自旋的无锁算法保证线程安全性，所以需要考虑各种并发情况
...
public class ConcurrentLinkedDeque<E>
        ...
        for (; ; )
            for (Node<E> h = head, p = h, q; ; ) {
                if ((q = p.prev) != null &&
                    ...
                    // p is first node       CASE3: p是队首结点
                    newNode.lazySetNext(p); // CAS piggyback “新结点”的next指向队首结点
     ...
     * <p>
     * 出队，last方法用于寻找队尾结点，即满足p.next == null && p.prev != p的结点
     *
     * @return
     */
    public E pollLast() {
    ...
    /**
     * 将元素推送到由此deque代表的堆栈（换句话说，在该deque的头部）
     *
    ...
    /**
     * 删除第一个元素 e ，使 o.equals(e) ，如果这样一个元素存在于这个deque，返回值为boolean
     * <p>
    ...
    /**
     * 返回 true如果这个deque包含至少一个元素 e ，返回值为Boolean
     * <p>
    ...
    /**
     * 以正确的顺序返回此deque中的元素的迭代器，返回值为Iterator
     * <p>
    ...
    /**
     * 以相反的顺序返回此deque中的元素的迭代器，返回值为Iterator
     * <p>
